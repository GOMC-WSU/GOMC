...
function(add_GPU_GEMC_test name)
	...
	if (CMAKE_BUILD_TYPE STREQUAL "Debug")
      ...
      #add_test(NAME PSFParserTest_GPU_GEMC COMMAND CheckProtAndWaterTest)
      add_test(NAME ConsistentTrajectoryTest_GPU_GEMC COMMAND CheckPDBTrajCoordinates)
      add_test(NAME CheckpointTest_GPU_GEMC COMMAND CheckMollookup)
      add_test(NAME EndianTest_GPU_GEMC COMMAND TestBitSwap)
