...
seed_number = 4
Liquid_box_Total_molecules = 5000
Liquid_box_length_Ang = 65

Vapor_box_Total_molecules = 5000
Vapor_box_length_Ang = 175
...
liq_methanol_box = mb.fill_box(compound=methanol,
                           n_compounds=Liquid_box_Total_molecules,
                           box=[Liquid_box_length_Ang/10, Liquid_box_length_Ang/10, Liquid_box_length_Ang/10],
                           seed=seed_number
                           )
#left_box_liq.energy_minimize(forcefield=DTPA_methanol_FF, steps=10**5)
print("INFO: Finished Building the liquid methanol box ")


vap_methanol_box = mb.fill_box(compound=methanol,
                           n_compounds=Vapor_box_Total_molecules,
                           box=[Vapor_box_length_Ang/10, Vapor_box_length_Ang/10, Vapor_box_length_Ang/10],
                           seed=seed_number
                           )
#left_box_liq.energy_minimize(forcefield=DTPA_methanol_FF, steps=10**5)
print("INFO: Finished Building the vapor methanol box ")
#empty_graphene_pore.save('test.xyz', overwrite=True)

print("INFO: Started Building the Charmm Object ")
# build the charmm object
charmm = mf_charmm.Charmm(liq_methanol_box,
                          'methanol_box_0',
                          structure_box_1=vap_methanol_box,
