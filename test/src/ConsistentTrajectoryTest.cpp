...
TEST(ConsistentTrajectoryTest, Check_PEN_HEX) {
    ...
    pdbnamesContinued[0] = "./test/input/Systems/PEN_HEX/Continued/Continued_BOX_0.pdb";
    pdbnamesContinued[1] = "./test/input/Systems/PEN_HEX/Continued/Continued_BOX_1.pdb";
...
TEST(ConsistentTrajectoryTest, Check_BPTI_TIP3) {
    ...
    pdbnamesContinued[0] = "./test/input/Systems/BPTI_TIP3/Continued/Continued_BOX_0.pdb";
    pdbnamesContinued[1] = "./test/input/Systems/BPTI_TIP3/Continued/Continued_BOX_1.pdb";

    pdbnamesSingleRun[0] = "./test/input/Systems/BPTI_TIP3/SingleRun/SingleRun_BOX_0.pdb";
    pdbnamesSingleRun[1] = "./test/input/Systems/BPTI_TIP3/SingleRun/SingleRun_BOX_1.pdb";
