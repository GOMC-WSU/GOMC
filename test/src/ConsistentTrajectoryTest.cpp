...
*/
    ...
    pdbBase.Init(rsBase, ifBase, pdbnamesBase, frameNum);    
    pdb1.Init(rs1, if1, pdbnames1, frameNum);
    pdbN.Init(rsN, ifN, pdbnamesN, frameNum);
    ...
    pdbBaseRestart.Init(rsBaseRestart, ifNull, pdbnamesBaseRestart);    
    pdb1Restart.Init(rs1Restart, ifNull, pdbnames1Restart);
    pdbNRestart.Init(rsNRestart, ifNull, pdbnamesNRestart);
