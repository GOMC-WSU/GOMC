...
set(GPU_NPT_flags "-DENSEMBLE=4 ${GEN_COMP_flag}" -Ofast -mavx -axAVX,CORE-AVX2")
set(GPU_NPT_name "GOMC_GPU_NPT")
set(GPU_GC_flags "-DENSEMBLE=3 ${GEN_COMP_flag}" -Ofast -mavx -axAVX,CORE-AVX2")
set(GPU_GC_name "GOMC_GPU_GCMC")
set(GPU_GE_flags "-DENSEMBLE=2 ${GEN_COMP_flag}" -Ofast -mavx -axAVX,CORE-AVX2")
set(GPU_GE_name "GOMC_GPU_GEMC")
set(GPU_NVT_flags "-DENSEMBLE=1 ${GEN_COMP_flag}" -Ofast -mavx -axAVX,CORE-AVX2")
...
if(ENSEMBLE_GPU_GEMC)
    ...
    set_property(TARGET GPU_GEMC PROPERTY CUDA_ARCHITECTURES all-major)
	if (CMAKE_BUILD_TYPE STREQUAL "Debug")
