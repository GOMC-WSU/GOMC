...
if(ENSEMBLE_GPU_NVT)
    ...
    target_link_libraries(GPU_NVT ${LIBRARIES_TO_LINK})
endif()
...
if(ENSEMBLE_GPU_GEMC)
    ...
    target_link_libraries(GPU_GEMC ${LIBRARIES_TO_LINK})
endif()
...
if(ENSEMBLE_GPU_GCMC)
    ...
    target_link_libraries(GPU_GCMC ${LIBRARIES_TO_LINK})
endif()
...
if(ENSEMBLE_GPU_NPT)
    ...
    target_link_libraries(GPU_NPT ${LIBRARIES_TO_LINK})
endif()
