...
if(ENSEMBLE_GPU_NVT)
    ...
    if(MPI_FOUND)
        ...
        target_link_libraries(GPU_NVT stdc++fs)
    endif()
endif()
...
if(ENSEMBLE_GPU_GEMC)
    ...
    if(MPI_FOUND)
        ...
        target_link_libraries(GPU_GEMC stdc++fs)
    endif()
endif()
...
if(ENSEMBLE_GPU_GCMC)
    ...
    if(MPI_FOUND)
        ...
        target_link_libraries(GPU_GCMC stdc++fs)
    endif()
endif()
...
if(ENSEMBLE_GPU_NPT)
    ...
    if(MPI_FOUND)
        ...
        target_link_libraries(GPU_NPT stdc++fs)
    endif()
endif()
