...
set(NPT_flags "-DENSEMBLE=4 -Ofast -mavx -axAVX,CORE-AVX2 -lineinfo")
set(NPT_name "GOMC_CPU_NPT")

#Grand Canonical Monte Carlo
set(GC_flags "-DENSEMBLE=3 -Ofast -mavx -axAVX,CORE-AVX2 -lineinfo")
set(GC_name "GOMC_CPU_GCMC")

#Gibbs Ensemble Monte Carlo
set(GE_flags "-DENSEMBLE=2 -Ofast -mavx -axAVX,CORE-AVX2 -lineinfo")
set(GE_name "GOMC_CPU_GEMC")

#NVT (Canonical) Ensemble
set(NVT_flags "-DENSEMBLE=1 -Ofast -mavx -axAVX,CORE-AVX2 -lineinfo")
