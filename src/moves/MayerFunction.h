...
********************************************************************************/
#ifndef MAYERFUNCTION_H
#define MAYERFUNCTION_H
...
class MayerFunction : public MoveBase, public MolTransformBase
{
public:

  MayerFunction(System &sys, StaticVals const& statV) : MoveBase(sys, statV) {}
...
void MayerFunction::PrintAcceptKind()
{
...
inline uint MayerFunction::ReplaceRot(Rotate const& other)
{
  ReplaceWith(other);
  return mv::fail_state::NO_FAIL;
}

inline uint MayerFunction::Prep(const double subDraw, const double movPerc)
{
...
inline uint MayerFunction::Transform()
{
...
inline void MayerFunction::CalcEn()
{
...
inline void MayerFunction::Accept(const uint rejectState, const ulong step)
{
