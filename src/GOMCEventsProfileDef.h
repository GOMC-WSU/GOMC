...
// I/O output
GOMC_PROFILE_EVENT(FILE_IO_OUTPUT, "output_file")
...
GOMC_PROFILE_EVENT(DCD_OUTPUT, "dcd_file")
GOMC_PROFILE_EVENT(DCD_RESTART_OUTPUT, "dcd_restart_file")
...
GOMC_PROFILE_EVENT(EN_BOX_INTRA, "energy_box_intra")
GOMC_PROFILE_EVENT(EN_BOX_INTER, "energy_box_inter")
GOMC_PROFILE_EVENT(EN_BOX_FORCE, "energy_box_force")
GOMC_PROFILE_EVENT(EN_BOX_TORQUE, "energy_box_torque")
